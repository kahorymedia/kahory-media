  ...
  return (
    <section className="relative min-h-screen w-full flex justify-center items-center overflow-hidden bg-black px-6 md:px-12 py-20 md:py-32">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between w-full max-w-[1200px] z-10 gap-10 md:gap-16 pointer-events-none mt-12 md:mt-0">
        ...
        <div className="flex-1 space-y-6 md:space-y-8 pointer-events-auto w-full">
          <div className="flex flex-col">
            <motion.h1 
              ...
              // FIX: Used strict sizing for mobile (text-5xl) to stop massive scaling
              className="text-5xl sm:text-6xl md:text-[clamp(3.5rem,8vw,6rem)] font-bold tracking-tighter leading-[0.9] uppercase text-white"
            >
              Stop<br />
            ...
            <motion.h1 
              ...
              className="text-5xl sm:text-6xl md:text-[clamp(3.5rem,8vw,6rem)] font-bold tracking-tighter leading-[0.9] uppercase text-white mt-1 md:mt-2"
            >
              Start<br />
        ...
        >
          {/* FIX: Set mobile max-width to 65% so it's not giant */}
          <img 
            src="/kahory media icon png 3-d.png" 
            alt="Kahory Icon" 
            className="w-full max-w-[65%] md:max-w-[80%] lg:max-w-[800px] h-auto drop-shadow-[0_0_150px_rgba(74,14,27,0.4)] select-none pointer-events-none"
            draggable="false"
          />
        </motion.div>
        ...
        <motion.div 
          ...
          // FIX: Moved slightly up on mobile so it doesn't overlap elements below
          className="absolute bottom-4 md:-bottom-24 left-0 w-16 h-16 md:w-20 md:h-20 flex items-center justify-center opacity-60 z-20 pointer-events-none"
        >
