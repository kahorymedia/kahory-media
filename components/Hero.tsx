    ...
    <section className="relative min-h-[90vh] md:min-h-[85vh] w-full flex justify-center items-center overflow-hidden bg-black px-6 md:px-12 pt-32 md:pt-40 pb-12 md:pb-0">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between w-full max-w-[1200px] z-10 gap-6 md:gap-16 pointer-events-none">
        ...
        <motion.div 
          ...
          className="absolute top-4 right-0 md:-bottom-24 md:left-0 md:top-auto w-16 h-16 md:w-20 md:h-20 flex items-center justify-center opacity-60 z-20 pointer-events-none"
        >
