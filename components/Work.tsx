...
export default function Work() {
  return (
    <section id="work" className="w-full bg-black flex justify-center overflow-hidden py-20 md:py-32">
      <div className="w-full max-w-[1200px]">
        
        <div className="mb-6 md:mb-16 px-6 md:px-0">
        ...
        {/* CTA BUTTONS: PRIMARY (Archive) AND SECONDARY (Drive) */}
        <div className="mt-8 md:mt-20 flex flex-col items-center gap-6">
          
          {/* PRIMARY: Link to Case Study Archive */}
