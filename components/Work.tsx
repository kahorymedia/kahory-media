...
export default function Work() {
  return (
    <section id="work" className="w-full py-40 px-6 md:px-12 bg-black flex justify-center">
      {/* INNER WRAPPER: Changed 1400px to 1200px to perfectly align with other sections */}
