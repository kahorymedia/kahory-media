...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function addKeywords(source: any, keywords: any) {
      ...
      let keywordsString = '';
      keywords.forEach((keyword: any) => { keywordsString += '#define ' + keyword + '\n'; });
