          ...
          <div className="flex flex-col gap-12">
            <div>
              ...
              <p className="text-white/60 font-light leading-relaxed text-sm md:text-lg">
                We partnered with {project.client} to build a high-converting short-form pipeline. The goal was simple: capture attention, prove authority in the {project.categories[0].toLowerCase()} space, and drive massive engagement.
              </p>
            </div>
